...
System.out.println(site.size());
 ...
 driver.findElement(By.xpath("android.widget.CheckedTextView[@text='Dashboard']")).click();
List<WebElement> general=driver.findElements(By.id("com.pazo.ppz:id/tvone"));
int total_schedule=general.size();
...
int count=0;
for(int i=0;i<5;i++){
Point p1=a.getPoint(general.get(general.size()-1));
Point p2=a.getPoint(general.get(0));
...
List<WebElement> general1=driver.findElements(By.id("com.pazo.ppz:id/tvone"));
count=general1.size();
